...
Extração de metadados & Certificados PDF com camada textual acessível contendo carga horária e data. & O sistema extraiu informações textuais utilizadas na pré-validação e no apoio ao preenchimento da carga horária. & Adequação da Extração de Metadados. \\
