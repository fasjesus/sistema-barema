...
O ciclo de caso de uso deste módulo encerra-se com o registro do parecer institucional no sistema e a consequente tentativa de notificação do discente. Assim que o coordenador submete a avaliação, o serviço de análise registra o parecer, atualiza o \textit{status} do protocolo no banco de dados e invoca o módulo de comunicação responsável por enviar o retorno ao aluno.
