...
Diante desse cenário, este trabalho propõe o desenvolvimento de um sistema \textit{web} de apoio à preparação do Barema de Atividades Complementares do curso de Ciência da Computação da UESC. A solução não busca substituir a análise institucional realizada pelo colegiado, mas atuar como uma camada de apoio à organização, à pré-validação e à geração padronizada do documento. O objetivo é reduzir erros formais antes da submissão oficial, melhorar a consistência das informações apresentadas e apoiar tanto o discente quanto a coordenação no fluxo de aproveitamento das Atividades Complementares.
